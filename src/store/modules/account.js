...
const state = {
  ...
  gitHubUsername: 'ZhiyuanYang6',  // 修改成你自己的 GitHub 账号
  copyright: '2017 - 2018',  // 修改成你自己的
  recordNumber: '湘ICP备18012340号-1',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'ZhiyuanYang6/vue-primary',  // 记录 Issue 的仓库的全名「用户名/仓库名」
